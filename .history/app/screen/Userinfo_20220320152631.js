   ...
   return (
     <SafeAreaView>
        ...
        <View style={{backgroundColor:"white", height:70, width:"100%", flexDirection:'row', paddingTop: 15, paddingLeft: 10, borderTopWidth: 2}}>
          ...
          <Text style={{width:"60%", paddingLeft: 20, height: 40,fontSize: 16, paddingTop:4}}>han.cao509@gmail.com</Text>
        </View>
        ...
        <View style={{backgroundColor:"white", height:70, width:"100%", flexDirection:'row', paddingTop: 15, paddingLeft: 10, borderTopWidth: 2}}>
          ...
          <Text style={{width:"60%", paddingLeft: 20, height: 40,fontSize: 24, paddingTop:4}}>ktx khu A đại học quốc gia</Text>
        </View>
