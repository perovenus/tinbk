     ...
     <SafeAreaView>
        ...
        <View style ={styles.body}>
            ...
            <View style={{backgroundColor:'blue', width:'50%', height: 200, flexDirection:'row'}}>
                <Text style={{width:'10%', height: 50}}>Tên: </Text>
                <Text style={{backgroundColor:'red', marginTop: 40, width:'90%', height: 50}}>Nickname</Text>
                <Text style={{width:'10%'}}>Tên: </Text>
                <Text style={{backgroundColor:'red', marginTop: 10, width:'90%'}}>Nickname</Text>
                <Text style={{width:'10%'}}>Tên: </Text>
                <Text style={{backgroundColor:'red', marginTop: 10, width:'90%'}}>Nickname</Text>
            </View>
        </View>
