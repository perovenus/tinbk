     ...
     <SafeAreaView>
        ...
        <View style ={styles.body}>
            ...
            <View style={{backgroundColor:'blue', width:'50%', height: 200, flexDirection:'row', flexWrap:'wrap'}}>
                ...
                <Text style={{backgroundColor:'red', width:'70%', height: 50, marginTop: 20}}>Nickname</Text>
                <Textstyle={{width:'30%', height: 50, marginTop: 20, textAlign:'center', justifyContent:'center'}}>Giới tính </Text>
                <Text style={{backgroundColor:'gray', width:'70%'}}>Gender</Text>
                <Text style={{width:'30%', height: 50}}>Tên: </Text>
                <Text style={{backgroundColor:'green',  width:'70%'}}>Birthday</Text>
            </View>
        </View>
