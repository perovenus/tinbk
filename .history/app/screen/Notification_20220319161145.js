   ...
   return (
     <SafeAreaView>
        ...
        <View style ={styles.footer}>
           <View style={{backgroundColor:'red',width:'25%'}}><Text>Home</Text></View>
           <View style={{backgroundColor:'black',width:'25%'}}><Text>Đăng bán</Text></View>
           <View style={{backgroundColor:'white',width:'25%'}}></View>
           <View style={{backgroundColor:'blue',width:'25%'}}></View>
        </View>
     </SafeAreaView>
   )
}
