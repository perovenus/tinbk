     ...
     <SafeAreaView>
        ...
        <View style ={styles.body}>
            ...
            <View style={{width:'50%', height: 200, flexDirection:'row', flexWrap:'wrap',alignContent:'center'}}>
                ...
                <Text style={{width:'40%', height: 40, textAlign:'center', justifyContent:'center'}}>Giới tính </Text>
                <Text style={{width:'60%',  justifyContent:'center'}}>Nam</Text>

                <Text style={{width:'40%', height: 40,  textAlign:'center', justifyContent:'center'}}>Ngày sinh </Text>
