...
const UserInfo = () => {
   return (
     <SafeAreaView>
        ...
        <View style={{backgroundColor:"white", height:70, width:"100%", flexDirection:'row', paddingTop: 15, paddingLeft: 10, borderTopWidth: 5}}>
          <Fontisto name="email" style={{fontSize:40}}/>
          <Text style={{width:"60%", paddingLeft: 30}}>email</Text>
        </View>
