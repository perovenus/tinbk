   ...
   return (
     <SafeAreaView>
        ...
        <View style ={styles.body}>
            ...
            <View style={{backgroundColor:'blue', width:'50%', height: 200, flexDirection:'row'}}>
                <Text style={{width:'10%'}}>Tên: </Text>
                <Text style={{backgroundColor:'red', marginTop: 40, width:'90%'}}>Nickname</Text>
                <Text>Giới tính: </Text>
                <Text style={{backgroundColor:'green', marginTop: 10}}>Gender</Text>
                <Text> Sinh nhật: </Text>
                <Text style={{backgroundColor:'yellow', marginTop: 10}}>Birthday</Text>
            </View>
        </View>
