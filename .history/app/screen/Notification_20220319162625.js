   ...
   return (
     <SafeAreaView>
        ...
        <View style ={styles.footer}>
           <View style={styles.iconfooter}><Text>Trang chủ</Text></View>
           <View style={styles.iconfooter}><Text>Đăng bán</Text></View>
           <View style={styles.iconfooter}><Text>Yêu thích</Text></View>
           <View style={styles.iconfooter}><Text>Cá nhân</Text></View>
        </View>
     </SafeAreaView>
   )
}
