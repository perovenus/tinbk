     ...
     <SafeAreaView>
        ...
        <View style ={styles.body}>
            ...
            <View style={{width:'50%', height: 200, flexDirection:'row', flexWrap:'wrap',alignContent:'center'}}>
                <Text style={{width:'40%', height: 30, marginTop: 60, textAlign:'center', justifyContent:'center',fontSize: 20}}>Tên </Text>
                <Text style={{width:'60%',  justifyContent:'center', paddingTop: 20,marginTop: 40,fontSize: 20}}>Perovenus</Text>

                <Text style={{width:'40%', height: 30, textAlign:'center', justifyContent:'center',fontSize: 20}}>Giới tính </Text>
                <Text style={{width:'60%',  justifyContent:'center',fontSize: 20}}>Nam</Text>

                <Text style={{width:'40%', height: 30,  textAlign:'center', justifyContent:'center',fontSize: 2016}}>Ngày sinh </Text>
                <Text style={{width:'60%',  justifyContent:'center',fontSize: 20}}>02/05/2001</Text>
            </View>
        </View>
