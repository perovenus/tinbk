   ...
   return (
     <SafeAreaView>
        ...
        <View style ={styles.body}>
            ...
            <View style={{backgroundColor:'blue', width:'50%', height: 200, flexDirection:'row', flexWrap:'w'}}>
                ...
                <Text style={{backgroundColor:'gay', marginTop: 10, width:'80%'}}>Gender</Text>
                <Text style={{width:'10%', height: 50}}>Tên: </Text>
                <Text style={{backgroundColor:'green', marginTop: 10, width:'80%'}}>Birthday</Text>
            </View>
        </View>
