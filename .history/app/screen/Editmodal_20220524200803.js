...
const Editmodal = (modalVisible, setModalVisible, user, userInfo) => {
  ...
  const data = [userInfo['middleName'], userInfo['lastName'], userInfo['phone']];
  const [middleName, setMiddleName] = useState(userInfo['middleName']);
  const [firstName, setFirstName] = useState(userInfo['firstName']);
  const [birthday, setBirthday] = useState(userInfo['birthday']);
  const [address, setAddress] = useState(userInfo['birthday']);
  const [phoneNumber, setPhoneNumber] = useState(userInfo['address']);
  console.log(middleName, firstName, birthday, address, phoneNumber);
