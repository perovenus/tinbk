      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View>
              {image  == ? (<Image style={styles.Avatar} source={{uri: image}} />) : user.image ? (<Image style={styles.Avatar} source={{uri: user.image}} />) : (<Image style={styles.Avatar}source={require('../assets/user.png')}/>)}
              <TouchableOpacity
                onPress={pickImage}
