      ...
      <ScrollView>
        ...
        <View style={styles.card}>
          <View style={styles.lefticon}>
            <Ionicons name="mail" size={24} color="#F0F0F0"></Ionicons>
          </View>
          <View>
        ...
        <View style={styles.card}>
          <View style={styles.lefticon}>
            <FontAwesome name="mobile-phone" size={24} color="#F0F0F0" />
          </View>
          <View>
        ...
        <TouchableOpacity style={styles.cardbonus}>
          <View style={styles.bonus}>
            <View style={styles.lefticon}>
              <FontAwesome name="shopping-cart" size={24} color="#F0F0F0" />
            </View>
            <View>
          ...
          <View>
            <FontAwesome name="angle-right" size={24} color="#F0F0F0" />
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.cardbonus}>
          <View style={styles.bonus}>
            <View style={styles.lefticon}>
              <FontAwesome name="lock" size={24} color="#F0F0F0" />
            </View>
            <View>
